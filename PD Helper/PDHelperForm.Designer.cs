...
namespace PD_Helper
{
    partial class PDHelperForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.savedArsenalListBox.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.savedArsenalListBox_DrawItem);
